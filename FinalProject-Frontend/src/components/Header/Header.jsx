...
function Header({ onLoginClick, goToSaved, goHome }) {
  return (
    <>
      <header className="header">
        ...
        <div className="header__bttn-container">
          <button className="header__home-button" onClick={goHome}>Home</button>
          <button className="header__saved-button" onClick={goToSaved}>Saved Articles</button>
